...
const Admin = () => {
  ...
  const submitRegistrationHandler = async (e) => {
    ...
    try {
      ...
      // 2️⃣ Mettre à jour Redux store avec les points
      const pointsToAdd = parseFloat(items[0]?.wallet) || 0;
      const updatedUserInfo = {
        ...userInfo,
        createdByUserCount: (userInfo.createdByUserCount || 0) + 1,
        allpoints: (userInfo.allpoints || 0) + pointsToAdd
      };
      dispatch(setCredentials(updatedUserInfo));
          ...
          <main className="container  mt-5 mb-5">
            ...
            <div className="card-elegant d-flex flex-column flex-md-row justify-content-between align-items-center  p-md-5 mb-4 text-center">
              ...
              <div className="mt-3 mt-md-0 text-center">
                ...
                <p className="number-h1">{pointInfo?.points} دينار</p>
              </div>
            </div>
