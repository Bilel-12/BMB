...
const Admin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // ✅ MISE À JOUR IMMÉDIATE DU SOLDE DANS REDUX
      const updatedUserInfo = {
        ...userInfo,
        points: userInfo.points - Number(pointsToSends), // Déduire les points envoyés
        allpoints: userInfo.allpoints - Number(pointsToSends) // Mettre à jour le total aussi
      };
  ...
  const submitRegistrationHandler = async (e) => {
    ...
    try {
      ...
      // ✅ Récupérer le user depuis la DB après l'inscription
      const updatedUser = await fetch(`https://bmb-backend-2.onrender.com/api/users/profile`, {
        method: "GET",
        credentials: "include"
      }).then(res => res.json());

      // Mettre à jour Redux store avec les données exactes de la DB
      dispatch(setCredentials(updatedUser));
      // Mettre à jour localStorage
      localStorage.setItem('userInfo', JSON.stringify(updatedUser));
      // Mettre à jour les générations localement
        ...
        <div className="particles" id="particles">
          ...
          <main className="container  mt-5 mb-5">
            ...
            <div className="table-elegant fade-in fade-in-2 mb-5">
              <div className="d-flex  flex-column  flex-md-row justify-content-between align-items-center p-4" style={{ background: 'var(--glass-bg)', backdropFilter: 'blur(20px)' }}>
                ...
                <div className="card-elegant p-4 h-100 fade-in fade-in-4">
                  <div className="d-flex align-items-center mb-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted mb-0">مستوى الشراكة المتقدم</p>
                    </div>
                  </div>
          ...
          >
            <div className=" p-2 p-md-4">
              <div className="text-center mb-2 mb-md-4">
                ...
                <h2 className="fw-bold mb-2 ">{userInfo.points >= 90 ? userInfo.points : 0}   د.ت</h2>
                ...
                <div className="update-popup-content">
                  ...
                  <form onSubmit={submitUpdateHandler}>
                    <div className="mb-3 p-1">
                      <input type="text" className="form-control" id="nom" name="nom" placeholder="الإسم" value={nom} onChange={(e) =>
                        setNom(e.target.value)}
                      />
                    </div>
                    <div className="mb-3 p-1">
                      <input type="text" className="form-control" id="prenom" name="prenom" placeholder="اللقب" value={prenom} onChange={(e) =>
                        setPrenom(e.target.value)}
                      />
                    </div>
                    <div className="mb-3 p-1">
